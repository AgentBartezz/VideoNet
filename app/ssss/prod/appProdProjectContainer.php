...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['bh_name_provider'] = new \Uek\Components\Name($this->get('session'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'sbazy.uek.krakow.pl', 'port' => NULL, 'dbname' => 's176041', 'user' => 's176041', 'password' => 'ZTwXXthp', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f95f6492df39460cea1a0d0de3677d4fec0dbc0927c40e427690decdf6495839');
        return $instance;
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'charset' => 'UTF-8', 'paths' => array()));
