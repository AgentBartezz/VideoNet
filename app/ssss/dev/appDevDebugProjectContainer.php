...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bh_name_provider' => 'getBhNameProviderService',
    ...
    /**
     * Gets the 'bh_name_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Uek\Components\Name\NameProvider A Uek\Components\Name\NameProvider instance.
     */
    protected function getBhNameProviderService()
    {
        return $this->services['bh_name_provider'] = new \Uek\Components\Name\NameProvider($this->get('session'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'sbazy.uek.krakow.pl', 'port' => NULL, 'dbname' => 's176041', 'user' => 's176041', 'password' => 'ZTwXXthp', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Grupa/VideoNetBundle/Entity'))), 'Grupa\\VideoNetBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('GrupaVideoNetBundle' => 'Grupa\\VideoNetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_08be21d1e775222ad7a6a25b7087550d487a5b7bd2ede8fb437e74683c4f24e3');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Grupa\\VideoNetBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Grupa\\VideoNetBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Grupa\\VideoNetBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Grupa\\VideoNetBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Grupa\\VideoNetBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/feeds/');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Uek/DemoBundle/Resources/views'), 'UekDemo');
        $instance->addPath(($this->targetDirs[3].'/src/Grupa/VideoNetBundle/Resources/views'), 'GrupaVideoNet');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UekDemoBundle' => 'Uek\\DemoBundle\\UekDemoBundle',
                'GrupaVideoNetBundle' => 'Grupa\\VideoNetBundle\\GrupaVideoNetBundle',
            ...
            'database_host' => 'sbazy.uek.krakow.pl',
            'database_port' => NULL,
            'database_name' => 's176041',
            'database_user' => 's176041',
            'database_password' => 'ZTwXXthp',
            ...
            'fos_user.model.user.class' => 'Grupa\\VideoNetBundle\\Entity\\User',
