...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GrupaVideoNetBundle:Movie')->findAll();
     ...
     * @Method("POST")
     * @Template("GrupaVideoNetBundle:Movie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GrupaVideoNetBundle:Movie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GrupaVideoNetBundle:Movie:edit.html.twig")
     */
